...
public class ResumeTestData {
    ...
    public static final List<Organization> ORGANIZATION_S = Arrays.asList(
            ...
            new Organization(new Link("Wrike", "http://wrike.com"), Arrays.asList(fillOrganizationPeriod("10/2014", "01/2016", "Старший разработчик (backend). Проектирование и разработка онлайн платформы управления проектами Wrike (Java 8 API, Maven, Spring, MyBatis, Guava, Vaadin, PostgreSQL, Redis). Двухфакторная аутентификация, авторизация по OAuth1, OAuth2, JWT SSO."))),
            new Organization(new Link("Java Online Projects", "http://topjava.ru"), Arrays.asList(fillOrganizationPeriod("10/2013", "03/2021", "Автор проекта.\n" +
